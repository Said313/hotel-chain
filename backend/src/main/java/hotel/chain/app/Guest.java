...
public class Guest extends User{
    ...
    public Guest(String firstname, String lastname, String password, Id_type id_type,
                String id_number, String address, String mobile_phone, String home_phone, GuestCategories category){
        super(firstname, lastname, password, id_type, id_number, address, mobile_phone, home_phone);
